...
check_depends() {
    ...
    depends=(wine wine32:i386 wineboot winecfg wineserver curl cabextract winbind wine-lol:i386 winbind libgnutls30 libldap-2.4-2 libopenal1 libpulse0 libasound2 libodbc1)
